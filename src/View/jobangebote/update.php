<!-- src/View/jobangebote/update.php -->
<!DOCTYPE html>
<html lang="de">
<head>
    <meta charset="UTF-8">
    <title>Jobangebot aktualisieren</title> <!-- Title of the page -->
</head>
<body>
    <h1>Jobangebot aktualisieren</h1> <!-- Heading of the page -->

    <!-- Form to update a job offer -->
